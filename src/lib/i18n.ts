...
const en = {
  ...
  boughtHint:
    "Removes it from the shopping list and saves it to Record. Amount is optional.",
  ...
  recordHint: "Bought items leave the shopping list and show up here with optional prices.",
  completed: "Completed",
  noRecordsYet: "No purchases logged yet",
  noRecordsHint: "When someone marks an item bought, it moves here from what we need.",
...
const zh: Dict = {
  ...
  open: "仍需要",
  markBought: "標記已買",
  boughtHint: "會從購物清單移除，並存到「紀錄」。金額可選。",
  whoBought: "購買人",
  ...
  amountPlaceholder: "28.50",
  recordHint: "已購買的項目會離開購物清單，並顯示在這裡（可附金額）。",
  completed: "已完成",
  noRecordsYet: "還沒有購買紀錄",
  noRecordsHint: "有人標記已買後，項目會從「家裡需要」移到這裡。",
  amountNone: "未填金額",
};
