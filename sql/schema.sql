-- Household Communicator schema (Neon / Postgres)
...
CREATE INDEX IF NOT EXISTS needs_household_idx ON needs(household_id);
CREATE INDEX IF NOT EXISTS needs_status_idx ON needs(household_id, status);
...
CREATE INDEX IF NOT EXISTS presence_household_idx ON presence(household_id);
